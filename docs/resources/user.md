...
For password login, use Terraform 1.11 or later and an ephemeral source. See [password setup and rotation](/providers/glitchedmob/kaneo/latest/docs/guides/passwords) for an example and source-security rules.
