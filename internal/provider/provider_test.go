...
func TestProviderRegistersTypes(t *testing.T) {
	...
	want := []string{"kaneo_workspace", "kaneo_project", "kaneo_column", "kaneo_task", "kaneo_label", "kaneo_task_label", "kaneo_user", "kaneo_workspace_role", "kaneo_workspace_member", "kaneo_team", "kaneo_team_member"}
