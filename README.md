...
- [Team member resource](docs/resources/team_member.md), manages accepted workspace users' team memberships. Bootstrap new teams with an explicit operator membership and `depends_on` for other members.
